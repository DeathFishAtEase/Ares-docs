...
extensions = ['sphinx.ext.todo', 'sphinx.ext.ifconfig', 'quickstart', 'roles']
...
project = u'Ares'
copyright = u'2025, The Ares Contributors，汉化 by ProsperousBeyond'
...
latex_documents = [
  ('index', 'Ares.tex', u'Ares Documentation',
   u'The Ares Contributors', 'manual'),
]
